// emailTemplate.js
const emailComings = (user, populatedMovie, movieLink) => {
    return `
                                ...
                                <tr style="border-collapse: collapse">
                                  ...
                                  >
                                    ...
                                    <div
                                      ...
                                      "
                                    >
                                  <p>The movie "${populatedMovie.title}" is coming soon to Flickzilla!</p><br>
                                  <p>Be ready to catch it as soon as it's released.</p>
                                    </div>
                                  </td>
                                </tr>
                                <tr style="border-collapse: collapse">
